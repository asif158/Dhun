        ...
        <div className="dashboard">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap:36, rowGap:16 }}>
            ...
            <div style={{ display: 'flex' }}>
              ...
              >{data?.amount?.category_10}</div>
            </div>
            {/* </div> */}
          </div>
          <div style={{margin:"20px"}}><BarChart data ={data?.amount}/></div >
          <button
            type="button"
            id="saveButton"
